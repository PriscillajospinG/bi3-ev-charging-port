...
VIDEO_FILENAME = "vehicle.mp4" # Found in file list
VIDEO_PATH = os.path.join(BASE_DIR, VIDEO_FILENAME)

MODEL_FILENAME = "yolo11l.pt"
...
# Load YOLO + Tracker
# --------------------------
# Ensure model weights exist or download/use correct path
try:
    model = YOLO(MODEL_PATH)
except:
    print(f"Warning: {MODEL_PATH} not found, trying 'yolo11n.pt' or default")
    model = YOLO("yolo11n.pt") # Fallback to smaller model if large one missing
